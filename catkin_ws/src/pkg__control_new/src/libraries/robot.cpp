...
//     //𝜃1
//     ur5::Vector4d z60(0, 0, -ur5::d6, 1);
//     ur5::Pose p50 = pose * z60;

//     double psi = atan2(p50(1), p50(0));
//     double phi = acos(ur5::d4 / hypot(p50(0), p50(1)));
//     double theta1 = psi + phi + M_PI_2;

//     //𝜃5
//     double p60x = pose(0,3);
//     double p60y = pose(1,3);
//     double theta5 = acos( (p60x * sin(theta1) - p60y * cos(theta1) - ur5::d4) / ur5::d6 );
...
ur5::Vector4d P(double th1, double th5, double th6, const Eigen::MatrixXd& T60){
    ...
    T65 = tMatrix(th6, ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5, ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T10 = tMatrix(th1, ur5::alpha[0], ur5::d[0], ur5::cn[0]);
...
ur5::JointAngles ur5::Robot::computeInverse(const Pose &pose) { 
    ...
    //theta5
    th5[0] =  acos( ( position(0)*sin(th1[0]) - position(1)*cos(th1[0]) - d[3] ) / d[5] );
    th5[1] = -acos( ( position(0)*sin(th1[0]) - position(1)*cos(th1[0]) - d[3] ) / d[5] );
    th5[2] =  acos( ( position(0)*sin(th1[1]) - position(1)*cos(th1[1]) - d[3] ) / d[5] );
    th5[3] = -acos( ( position(0)*sin(th1[1]) - position(1)*cos(th1[1]) - d[3] ) / d[5] );
    ...
    //theta3
    ur5::Pose T41m_1 = tMatrix(th1[0], alpha[0], d[0], cn[0]).inverse() * T60* tMatrix(th6[0], alpha[5], d[5], cn[5]).inverse() * tMatrix(th5[0], alpha[4], d[4], cn[4]).inverse();
    Eigen::Vector3d p41_1 = T41m_1.block<3,1>(0,3);
    double p41xz_1 = hypot(p41_1(0), p41_1(2));

    ur5::Pose T41m_2 = tMatrix(th1[0], alpha[0], d[0], cn[0]).inverse() * T60* tMatrix(th6[1], alpha[5], d[5], cn[5]).inverse() * tMatrix(th5[1], alpha[4], d[4], cn[4]).inverse();
    Eigen::Vector3d p41_2 = T41m_2.block<3,1>(0,3);
    double p41xz_2 = hypot(p41_2(0), p41_2(2));

    ur5::Pose T41m_3 = tMatrix(th1[1], alpha[0], d[0], cn[0]).inverse() * T60* tMatrix(th6[2], alpha[5], d[5], cn[5]).inverse() * tMatrix(th5[2], alpha[4], d[4], cn[4]).inverse();
    Eigen::Vector3d p41_3 = T41m_3.block<3,1>(0,3);
    double p41xz_3 = hypot(p41_3(0), p41_3(2));

    ur5::Pose T41m_4 = tMatrix(th1[1], alpha[0], d[0], cn[0]).inverse() * T60* tMatrix(th6[3], alpha[5], d[5], cn[5]).inverse() * tMatrix(th5[3], alpha[4], d[4], cn[4]).inverse();
    Eigen::Vector3d p41_4 = T41m_4.block<3,1>(0,3);
    double p41xz_4 = hypot(p41_4(0), p41_4(2));

    th3[0] = acos( (pow(p41xz_1, 2) - pow(ur5::a2, 2) - pow(ur5::a3, 2)) / (2 * ur5::a2 * ur5::a3));
    th3[1] = acos( (pow(p41xz_2, 2) - pow(ur5::a2, 2) - pow(ur5::a3, 2)) / (2 * ur5::a2 * ur5::a3));
    th3[2] = acos( (pow(p41xz_3, 2) - pow(ur5::a2, 2) - pow(ur5::a3, 2)) / (2 * ur5::a2 * ur5::a3));
    th3[3] = acos( (pow(p41xz_4, 2) - pow(ur5::a2, 2) - pow(ur5::a3, 2)) / (2 * ur5::a2 * ur5::a3));
    th3[4] = -th3[0];
    th3[5] = -th3[1];
    th3[6] = -th3[2];
    th3[7] = -th3[3];
    ...
    //theta2
    th2[0] = atan2(-p41_1(2), -p41_1(0)) - asin( (-ur5::a3 * sin(th3[0])) / (p41xz_1) );
    th2[1] = atan2(-p41_2(2), -p41_2(0)) - asin( (-ur5::a3 * sin(th3[1])) / (p41xz_2) );
    th2[2] = atan2(-p41_3(2), -p41_3(0)) - asin( (-ur5::a3 * sin(th3[2])) / (p41xz_3) );
    th2[3] = atan2(-p41_4(2), -p41_4(0)) - asin( (-ur5::a3 * sin(th3[3])) / (p41xz_4) );
    th2[4] = atan2(-p41_1(2), -p41_1(0)) - asin( ( ur5::a3 * sin(th3[0])) / (p41xz_1) );
    th2[5] = atan2(-p41_2(2), -p41_2(0)) - asin( ( ur5::a3 * sin(th3[1])) / (p41xz_2) );
    th2[6] = atan2(-p41_3(2), -p41_3(0)) - asin( ( ur5::a3 * sin(th3[2])) / (p41xz_3) );
    th2[7] = atan2(-p41_4(2), -p41_4(0)) - asin( ( ur5::a3 * sin(th3[3])) / (p41xz_4) );

    //th4
    T65 = tMatrix(th6[0], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[0], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[0], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[0], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T10 = tMatrix(th1[0], ur5::alpha[0], ur5::d[0], ur5::cn[0]);
    ...
    T65 = tMatrix(th6[1], ur5::alpha[5], ur5::d[5], ur5::cn[5]);;
    T54 = tMatrix(th5[1], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[1], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[1], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    Eigen::Vector3d v1(T43(0,0), T43(1,0), T43(2,0));
    th4[1] = atan2(v1(1), v1(0));

    T65 = tMatrix(th6[2], ur5::alpha[5], ur5::d[5], ur5::cn[5]);;
    T54 = tMatrix(th5[2], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[2], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[2], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T10 = tMatrix(th1[1], ur5::alpha[0], ur5::d[0], ur5::cn[0]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    Eigen::Vector3d v2(T43(0,0), T43(1,0), T43(2,0));
    th4[2] = atan2(v2(1), v2(0));

    T65 = tMatrix(th6[3], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[3], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[3], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[3], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    ...
    T65 = tMatrix(th6[0], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[0], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[4], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[4], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T10 = tMatrix(th1[0], ur5::alpha[0], ur5::d[0], ur5::cn[0]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    ...
    T65 = tMatrix(th6[1], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[1], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[5], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[5], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    ...
    T65 = tMatrix(th6[2], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[2], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[6], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[6], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T10 = tMatrix(th1[1], ur5::alpha[0], ur5::d[0], ur5::cn[0]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    ...
    T65 = tMatrix(th6[3], ur5::alpha[5], ur5::d[5], ur5::cn[5]);
    T54 = tMatrix(th5[3], ur5::alpha[4], ur5::d[4], ur5::cn[4]);
    T32 = tMatrix(th3[7], ur5::alpha[2], ur5::d[2], ur5::cn[2]);
    T21 = tMatrix(th2[7], ur5::alpha[1], ur5::d[1], ur5::cn[1]);
    T43 = T32.inverse() * T21.inverse() * T10.inverse() * T60 * T65.inverse() * T54.inverse();
    ...
    for(int i=0; i<8; i++) {
        ...
        ur5::Pose difference = solution - T60;
