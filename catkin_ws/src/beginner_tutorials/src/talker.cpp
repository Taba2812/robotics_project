...
int main(int argc, char **argv){
     ...
     * After this advertise() call is made, the master node will notify anyone who is trying to subscribe to this topic name, and they'll in turn negotiate a p2p connection with this node.
    ...
    //sleep for the right amount of time to hit the right frequency
    loop_rate.sleep();
